...
print("Voilà l'histoire de {0} et de leur animal de compagnie {1}.  Un jour, {0} et leur {2} marchaient et ils se sont croisés {3} dans la rue. {3} se promenait et la police s'est approchée pour tenter de l'arrêter.  {0} et {3} {4} loin des policiers et a finit par se cacher à {5}.".format(nom,adjectif,animal,nom2,verbe,endroit))
